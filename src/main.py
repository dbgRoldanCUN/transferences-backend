...
from transference.transf_routes import cons_transf_blueprint
from admin.admin_routes import cons_admin_blueprint
from subject.subject_routes import cons_subj_blueprint
